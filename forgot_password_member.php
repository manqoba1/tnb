...
if ($json_results->email) {
	...
	if(mysql_num_rows($checkemail)  < 1) {
		...
		$result = mysql_query("update communitymember set password='$encrypt' where email='$email'");
			...
			$response["message"] = "Password recovered.";
			 ...
			 $RegMessage='
				...
				<div style="margin-left: 20px;">
				  <img src="http://tnb.freevar.com/tnb/images/logo.png" align="center" style="height: 250px; width: 300px;"/><br />
	...
	&#169; GKElectronics 2014 property of Geekulcha (Pty) Ltd
		</div>          
				  </body>
				  </html>
				  ';
